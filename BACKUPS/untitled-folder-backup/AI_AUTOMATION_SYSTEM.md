...
## GitHub Copilot ↔ Claude Coordination Guide

**Created:** October 17, 2025  
**Purpose:** Enable semi-automated workflow between GitHub Copilot and Claude AI  
...
1. Todd assigns tasks to either AI
2. Each AI completes their task and signals completion
3. The other AI picks up the next dependent task
4. Both AIs auto-update collaboration logs
5. Minimal manual coordination required
